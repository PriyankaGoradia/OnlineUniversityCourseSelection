...
class _FloatingQuickAccessBarState extends State<FloatingQuickAccessBar> {
  ...
  List<String> items = ['Headquarters', 'Dates', 'Meet the team', 'Experience'];
  List<IconData> icons = [
    Icons.location_on,
    Icons.date_range,
    Icons.people,
    ...
    for (int i = 0; i < items.length; i++) {
      Widget elementTile = InkWell(
        ...
        child: Text(
          items[i],
          style: TextStyle(
            fontWeight: _isHovering[i] ? FontWeight.bold : null,
            fontSize: _isHovering[i] ? 24 : 16,
            color: _isHovering[i]
    ...
    return Center(
      ...
      child: Padding(
        padding: EdgeInsets.only(
          ...
          //top:ResponsiveWidget.isSmallScreen(context)? widget.screenSize.height * 0.40:widget.screenSize.height * 0.010,
