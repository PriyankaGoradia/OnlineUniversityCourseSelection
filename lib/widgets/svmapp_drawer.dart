...
class SvmappDrawer extends StatefulWidget {
  const SvmappDrawer({
    Key key,
  }) : super(key: key);

  @override
  _SvmappDrawerState createState() => _SvmappDrawerState();
}

class _SvmappDrawerState extends State<SvmappDrawer> {
